...
<html>
    ...
    <table width = 100%>
        ...
        <div id="modifDemande" idDemande='<?php $uneDemande->idDemande?>'></div>
        <div class='col-xl-4 col-lg-4 col-md-6 col-sm-12'>
            <div class='our-services-wrapper mb-60'>
                <div class='services-inner'>
                    <div class='our-services-img'>
                        ...
                        <div class='our-services-text' DescDemande=<?php $uneDemande->descriptionDemande ?>>
    ...
    <table width = 100%>
        ...
        <script>
            var boxOffre = $(".boxOffre")
            var i = 0;
            while(i < boxOffre.length) {
                boxOffre[i].addEventListener("click", afficherModOffre)
                i++;
            }
            var boxDemande = $(".boxDemande")
            var j = 0;
            while(j < boxDemande.length){
                boxDemande[j].addEventListener("click", afficherModDemande)
                j++;
            }
        </script>
    </body>
